...
class __TwigTemplate_ff3265e63b1233a1900f52c0ffc29a99 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["contact_form"]) || array_key_exists("contact_form", $context) ? $context["contact_form"] : (function () { throw new RuntimeError('Variable "contact_form" does not exist.', 7, $this->source); })()), 'form');
        echo " 
   ";
        // line 16
        echo "
...
";
    ...
    {
        return array (  71 => 24,  68 => 16,  64 => 7,  59 => 4,  52 => 3,  35 => 1,);
    }
...
{% block body %}
   ...
   {#  <div class=\"row g-3\">
        <div class=\"position-absolute top-50 start-50 translate-middle col-md-6\">
            ...
            <div class=\"col\">{{ form_row(contact_form.Submit)  }}</div>   
        </div>
    </div> #}

    {#Symfony Bootstrap 5 Form Them twig #}
